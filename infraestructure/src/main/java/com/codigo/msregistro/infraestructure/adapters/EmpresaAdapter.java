...
public class EmpresaAdapter implements EmpresaServiceOut {
    ...
    public EmpresaDTO actualizarOut(Long id, RequestEmpresa requestEmpresa) {
        ...
        if(existe){
            ...
            ResponseSunat responseSunat = getExecutionSunat(requestEmpresa.getRuc());
    ...
    private EmpresaEntity getEntity(ResponseSunat reniec, RequestEmpresa requestEmpresa){
        TipoDocumentoEntity tipoDocumento = tipoDocumentoRepository.findByCodTipo(reniec.getTipoDocumento());
        EmpresaEntity entity = new EmpresaEntity();
        entity.setNumDocu(reniec.getNumeroDocumento());
        entity.setRazonSocial(reniec.getRazonSocial());
        entity.setNomComercial(reniec.getRazonSocial());
    ...
    private EmpresaEntity getEntityUpdate(ResponseSunat sunat, EmpresaEntity empresaActualizar){
        ...
        //empresaActualizar.setApeMat(sunat.getApellidoMaterno());
